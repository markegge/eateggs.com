...
<footer class="s-foot">
	...
	<h2><?php esc_html_e( 'New posts, no schedule.', 'eateggs' ); ?> <a href="<?php echo esc_url( get_feed_link() ); ?>"><?php esc_html_e( 'Subscribe via RSS.', 'eateggs' ); ?></a></h2>
	...
	<div class="foot-links">
		...
		<a href="https://x.com/markegge" target="_blank" rel="noopener"><?php esc_html_e( 'X', 'eateggs' ); ?></a>
		<a href="https://linkedin.com/in/markegge" target="_blank" rel="noopener"><?php esc_html_e( 'LinkedIn', 'eateggs' ); ?></a>
		<a href="https://www.strava.com/athletes/markegge" target="_blank" rel="noopener"><?php esc_html_e( 'Strava', 'eateggs' ); ?></a>
		<a href="https://www.instagram.com/markegge/" target="_blank" rel="noopener"><?php esc_html_e( 'Instagram', 'eateggs' ); ?></a>
